...
; RUN: opt -S %s -passes=lowertypetests -lowertypetests-summary-action=export -lowertypetests-read-summary=%s -reorder-cfi-jump-tables-profiles=false | FileCheck --check-prefix=NO-REORDER %s
...
;
;
; NO-REORDER-LABEL: define hidden void @f_hot.cfi(
; NO-REORDER-SAME: ) !type [[META1:![0-9]+]] !type [[META9:![0-9]+]] !guid [[META10:![0-9]+]] {
; NO-REORDER-NEXT:    ret void
;
;
; NO-REORDER-LABEL: define hidden void @g_unknown.cfi(
; NO-REORDER-SAME: ) !type [[META6:![0-9]+]] !type [[META9]] !guid [[META11:![0-9]+]] {
; NO-REORDER-NEXT:    ret void
;
;
; NO-REORDER-LABEL: define hidden void @f_cold.cfi(
; NO-REORDER-SAME: ) !type [[META1]] !type [[META9]] !guid [[META12:![0-9]+]] {
; NO-REORDER-NEXT:    ret void
;
;
; NO-REORDER-LABEL: define hidden void @g_other.cfi(
; NO-REORDER-SAME: ) !type [[META6]] !type [[META9]] !guid [[META13:![0-9]+]] {
; NO-REORDER-NEXT:    ret void
;
;
; NO-REORDER-LABEL: define hidden void @f_other.cfi(
; NO-REORDER-SAME: ) !type [[META1]] !type [[META9]] !guid [[META14:![0-9]+]] {
; NO-REORDER-NEXT:    ret void
;
;
; NO-REORDER-LABEL: define hidden void @g_cold.cfi(
; NO-REORDER-SAME: ) !type [[META6]] !type [[META9]] !guid [[META15:![0-9]+]] {
; NO-REORDER-NEXT:    ret void
;
;
; NO-REORDER-LABEL: define hidden void @f_unknown.cfi(
; NO-REORDER-SAME: ) !type [[META1]] !type [[META9]] !guid [[META16:![0-9]+]] {
; NO-REORDER-NEXT:    ret void
;
;
; NO-REORDER-LABEL: define i1 @test_typeid1(
; NO-REORDER-SAME: ptr [[P:%.*]]) {
; NO-REORDER-NEXT:    [[TMP1:%.*]] = ptrtoint ptr [[P]] to i64
; NO-REORDER-NEXT:    [[TMP2:%.*]] = sub i64 ptrtoint (ptr getelementptr (i8, ptr @.cfi.jumptable, i64 24) to i64), [[TMP1]]
; NO-REORDER-NEXT:    [[TMP3:%.*]] = call i64 @llvm.fshr.i64(i64 [[TMP2]], i64 [[TMP2]], i64 3)
; NO-REORDER-NEXT:    [[TMP4:%.*]] = icmp ule i64 [[TMP3]], 3
; NO-REORDER-NEXT:    ret i1 [[TMP4]]
;
;
; NO-REORDER-LABEL: define i1 @test_typeid2(
; NO-REORDER-SAME: ptr [[P:%.*]]) {
; NO-REORDER-NEXT:    [[TMP1:%.*]] = ptrtoint ptr [[P]] to i64
; NO-REORDER-NEXT:    [[TMP2:%.*]] = sub i64 ptrtoint (ptr getelementptr (i8, ptr @.cfi.jumptable, i64 48) to i64), [[TMP1]]
; NO-REORDER-NEXT:    [[TMP3:%.*]] = call i64 @llvm.fshr.i64(i64 [[TMP2]], i64 [[TMP2]], i64 3)
; NO-REORDER-NEXT:    [[TMP4:%.*]] = icmp ule i64 [[TMP3]], 6
; NO-REORDER-NEXT:    ret i1 [[TMP4]]
;
;
; NO-REORDER-LABEL: define i1 @test_generalized(
; NO-REORDER-SAME: ptr [[P:%.*]]) {
; NO-REORDER-NEXT:    [[TMP1:%.*]] = ptrtoint ptr [[P]] to i64
; NO-REORDER-NEXT:    [[TMP2:%.*]] = sub i64 ptrtoint (ptr getelementptr (i8, ptr @.cfi.jumptable, i64 48) to i64), [[TMP1]]
; NO-REORDER-NEXT:    [[TMP3:%.*]] = call i64 @llvm.fshr.i64(i64 [[TMP2]], i64 [[TMP2]], i64 3)
; NO-REORDER-NEXT:    [[TMP4:%.*]] = icmp ule i64 [[TMP3]], 2
; NO-REORDER-NEXT:    ret i1 [[TMP4]]
;
;
...
; NO-REORDER-NEXT:    call void asm sideeffect "jmp ${0:c}@plt\0Aint3\0Aint3\0Aint3\0A", "s"(ptr @f_other.cfi)
; NO-REORDER-NEXT:    call void asm sideeffect "jmp ${0:c}@plt\0Aint3\0Aint3\0Aint3\0A", "s"(ptr @f_unknown.cfi)
; NO-REORDER-NEXT:    call void asm sideeffect "jmp ${0:c}@plt\0Aint3\0Aint3\0Aint3\0A", "s"(ptr @g_unknown.cfi)
; NO-REORDER-NEXT:    call void asm sideeffect "jmp ${0:c}@plt\0Aint3\0Aint3\0Aint3\0A", "s"(ptr @g_other.cfi)
; NO-REORDER-NEXT:    call void asm sideeffect "jmp ${0:c}@plt\0Aint3\0Aint3\0Aint3\0A", "s"(ptr @g_cold.cfi)
; NO-REORDER-NEXT:    unreachable
;
;.
...
;.
; NO-REORDER: [[META1]] = !{i32 0, !"typeid1"}
; NO-REORDER: [[META6]] = !{i32 0, !"typeid.generalized"}
; NO-REORDER: [[META9]] = !{i32 0, !"typeid2"}
; NO-REORDER: [[META10]] = !{i64 -9069525309280496021}
; NO-REORDER: [[META11]] = !{i64 -1755363370770001354}
; NO-REORDER: [[META12]] = !{i64 3658589069114391263}
; NO-REORDER: [[META13]] = !{i64 -365719035820452472}
; NO-REORDER: [[META14]] = !{i64 1928809046209326017}
; NO-REORDER: [[META15]] = !{i64 4485074774011110174}
; NO-REORDER: [[META16]] = !{i64 1205929326482009600}
; NO-REORDER: [[META17]] = !{i64 1879002126, i64 8}
;.
