...
protected:
...
#ifndef NDEBUG
  void verifyDAGAndSchedule(const DmpVector<SBValue *> &Bndl,
  ...
  bool maybeStopRecursionForDebugging(const DmpVector<SBValue *> &Bndl,
                                      AnalysisResult *&AnalysisRes);
  SBValue *
  vectorizeRec(const DmpVectorView<SBValue *> &Bndl,
               AnalysisResult *AnalysisRes,
  ...
  /// Scalars.
  void emitUnpacks(SBValue *Vec, const DmpVector<SBValue *> &Scalars);
#ifndef NDEBUG
...
#endif
  static SBValue *createVecInstruction(const DmpVector<SBValue *> &Bndl,
...
public:
  VectorizeFromSeeds(SBBasicBlock *SBBB, SBVecContext &Ctxt,
                     ScalarEvolution &SE, const DataLayout &DL,
                     TargetTransformInfo &TTI);
  SBInstruction *tryVectorize(const DmpVectorView<SBValue *> &Seeds,
                              SBRegion &Rgn,
...
public:
  static SBValue *
  vectorizeRec(VectorizeFromSeeds &Vec, DmpVector<SBValue *> &Bndl,
               AnalysisResult *AnalysisRes,
               SmallPtrSet<SBInstruction *, 4> &EraseCandidates, bool TopDown,
               SBValue *VecOp = nullptr) {
...
public:
  VectorizeScalars(SBVecContext &Ctxt, ScalarEvolution &SE,
