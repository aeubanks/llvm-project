...
# RUN: ld.lld -pie --got-partition-threshold=0x4000 -z max-page-size=4096 %t.o -o %t.exe -Map=%t.map
...
# PHDR-NEXT: GNU_RELRO      {{.*}} 0x00000000000124e8 0x00000000000124e8 0x0000c0 0x000b18 R   0x1
