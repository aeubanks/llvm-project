...
; JT4:  define private void @[[JT]]() #[[ATTR:.*]] prefalign(4) code_model "small" !elf_section_properties ![[PROP:[0-9]*]] {
; JT8:  define private void @[[JT]]() #[[ATTR:.*]] prefalign(8) code_model "small" !elf_section_properties ![[PROP:[0-9]*]] {
; JT16: define private void @[[JT]]() #[[ATTR:.*]] prefalign(16) code_model "small" !elf_section_properties ![[PROP:[0-9]*]] {
