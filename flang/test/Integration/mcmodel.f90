...
! CHECK-TINY: !{{[0-9]+}} = !{i32 9, !"Code Model", i32 0}
! CHECK-SMALL: !llvm.module.flags = !{{{.*}}}
! CHECK-SMALL: !{{[0-9]+}} = !{i32 9, !"Code Model", i32 1}
! CHECK-KERNEL: !llvm.module.flags = !{{{.*}}}
! CHECK-KERNEL: !{{[0-9]+}} = !{i32 9, !"Code Model", i32 2}
! CHECK-MEDIUM: !llvm.module.flags = !{{{.*}}}
! CHECK-MEDIUM: !{{[0-9]+}} = !{i32 9, !"Code Model", i32 3}
! CHECK-LARGE: !llvm.module.flags = !{{{.*}}}
! CHECK-LARGE: !{{[0-9]+}} = !{i32 9, !"Code Model", i32 4}
